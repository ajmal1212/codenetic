...
import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, r as renderTemplate, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, u as unescapeHTML, f as escape, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, d as renderComponent } from './astro/server_BG5POMIu.mjs';
/* empty css                        */
...
}, "/workspaces/codenetic/src/components/ui/Badge.astro", void 0);
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_u2Q61g6l.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://foxi.netlify.app/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DQL_3Swb.mjs').then(n => n._);
...
export { $$Badge as $, getCollection as g, renderEntry as r };
